...
//     -I/path/to/caffe/build/slrc/caffe/proto ...
//     caffe_proto_.cc ...
...
//     -I/path/to/caffe/build/src
//     -I/usr/local/cuda/include...
//     caffe_proto_.cc ...
//     ../path/to/caffe/build/src/caffe/proto/caffe.pb.o ...
//     ../path/to/caffe/build/src/caffe/util/io.o...
//     -lprotobuf CXXFLAGS="$CXXFLAGS -std=c++11"...
//     -lglog -lboost_system -lopencv_core -lopencv_highgui -lopencv_imgproc
// Usage.
//
// fid = fopen('cat.jpg', 'r');
...
MEX_DEFINE(fromDatum) (int nlhs, mxArray* plhs[],
  ...
  if (datum.has_encoded() && datum.encoded()) {
    ...
    printf("height %d, width %d, channel %d, label %d, encoded %d,\n",
           datum.height(),datum.width(),datum.channels(),datum.label(),datum.encoded());
